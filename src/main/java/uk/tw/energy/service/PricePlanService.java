...
public class PricePlanService {
	...
	/*
	 * public BigDecimal calcAvgCostOfLastOneWeek(String smartMeterId) {
	 * Optional<List<ElectricityReading>> readings =
	 * meterReadingService.getReadingsOfLastOneWeek(smartMeterId);
	 * 
	 * if(!readings.isPresent()) { return BigDecimal.valueOf(0.0); }
	 * 
	 * BigDecimal avgReadings = calculateAverageReading(readings.get()); return
	 * null; }
	 */
