...
public class MeterReadingController {
    ...
    public ResponseEntity readReadings(@PathVariable String smartMeterId) {
    	debug("Reading meter for id: %s", smartMeterId);
	...
	@GetMapping(path = {"/"})
    public ResponseEntity readings() {
		debug("meter readings", "defaults");
    	return ResponseEntity.ok(meterReadingService.getReadings());
    }
