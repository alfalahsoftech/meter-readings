...
public class PricePlanComparatorController {
	...
	/*
	 * @GetMapping("/lastWeekAvgCost/{smartMeterId}") public
	 * ResponseEntity<BigDecimal> recommendCheapestPricePlans(@PathVariable String
	 * smartMeterId){
	 * 
	 * }
	 * 
	 * @GetMapping("/monthlyAvgCost/{smartMeterId}") public
	 * ResponseEntity<BigDecimal> recommendCheapestPricePlans(@PathVariable String
	 * smartMeterId){
	 * 
	 * }
